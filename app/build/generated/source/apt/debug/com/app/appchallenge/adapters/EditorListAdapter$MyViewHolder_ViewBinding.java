...
public class EditorListAdapter$MyViewHolder_ViewBinding implements Unbinder {
  private EditorListAdapter.MyViewHolder target;

  @UiThread
  public EditorListAdapter$MyViewHolder_ViewBinding(EditorListAdapter.MyViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    EditorListAdapter.MyViewHolder target = this.target;
